...
export function AddToCartIcon ({ className }) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-plus ${className}`}
    >
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
...
export function RemoveFromCartIcon ({ className }) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`icon icon-tabler icons-tabler-outline icon-tabler-shopping-cart-x ${className}`}
    >
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
      <path d='M4 19a2 2 0 1 0 4 0a2 2 0 0 0 -4 0' />
...
export function XIcon ({ className }) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      class={`icon icon-tabler icons-tabler-outline icon-tabler-x ${className}`}
    >
      <path stroke='none' d='M0 0h24v24H0z' fill='none' />
      <path d='M18 6l-12 12' />
      <path d='M6 6l12 12' />
